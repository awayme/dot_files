if exists('g:GuiLoaded')
    " Guifont DejaVu Sans Mono:h22
    " Guifont Consolas:h11,Courier_New:h11:cANSI
    "GuiForeground()
    "VimRHideTools
    "VimRMaximizeWindow
    " set guifont=微软雅黑_light:14
    "
    set guifont=Courier:h13:cANSI
    set guifontwide=NSimSun:h13 " guifontwide只有在encoding=utf-8时才生效
endif
